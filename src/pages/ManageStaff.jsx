      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <div className="p-3 bg-linear-to-brrom-blue-600 to-indigo-600 rounded-xl shadow-lg">
              <Users className="w-7 h-7 text-black" />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-slate-800">Staff Management</h1>
              <p className="text-slate-600 text-sm mt-1">Manage your team members and access controls</p>
            </div>
          </div>
        </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
              <div className="lg:col-span-1">
                ...
                <input
                  className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none"
              ...
              <div className="lg:col-span-1">
                ...
                <select
                  className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none bg-white"
                  value={status}
            ...
            <div className="flex gap-3 pt-2">
              <button
                onClick={saveStaff}
                disabled={loading}
                className="flex items-center gap-2 bg-linear-to-r from-blue-600 to-indigo-600 text-white px-6 py-2.5 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed font-medium"
              >
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none w-full sm:w-64"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="pl-10 pr-8 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none bg-white appearance-none cursor-pointer"
                  >
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-linear-to-br from-blue-500 to-indigo-500 flex items-center justify-center text-white font-semibold">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex gap-2">
                          <button
                            onClick={() => editStaff(s)}
                            className="flex items-center gap-1.5 bg-amber-100 text-amber-700 px-3 py-1.5 rounded-lg hover:bg-amber-200 transition-all text-sm font-medium"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 bg-red-100 text-red-700 px-3 py-1.5 rounded-lg hover:bg-red-200 transition-all text-sm font-medium"
                          >
